...
import 'package:crafty_bay/features/product/presentation/providers/product_by_category_provider.dart';
...
class _ProductListByCategoryScreenState extends State<ProductListByCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider<ProductListByCategoryProvider>(
